...
" syntax coloring for JSDoc comments (HTML)
  ...
  syntax match  javaScriptDocTags       contained "@\(param\|argument\|returns\=\|requires\|exception\|throws\|type\|class\|extends\|see\|link\|member\|module\|method\|title\|namespace\|optional\|default\|base\|property\|file\)\>" nextgroup=javaScriptDocParam,javaScriptDocSeeTag skipwhite
...
syn match javaScriptFuncName /[$_a-zA-Z][$_a-zA-Z]*\ze\s*=\s*function\s*([^()]*)/
...
syn match javaScriptMethName /\zs['""']\{-}[$_a-zA-Z][$_a-zA-Z]*['""']\{-}\ze\s*:\s*function\s*([^()]*)/
...
if version >= 508 || !exists("did_javascript_syn_inits")
  ...
  " Ajax Highlighting
    ...
    HiLink javaScriptMethName           Function
